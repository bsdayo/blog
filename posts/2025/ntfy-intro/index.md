...
![点击右下角加号](https://images.bsdayo.moe/ntfy-intro/ntfy-android-subscribe.jpg){width=300}

Instant delivery 模式会启动一个前台服务（在通知栏创建一条永久通知），可以保证在锁屏等情况下仍然能及时接收到信息。这个通知可以在 ntfy 的应用设置里关掉 Subscription Service 的通知来隐藏，不影响功能。

![接收到频道内的通知](https://images.bsdayo.moe/ntfy-intro/ntfy-android-received.jpg){width=300}
...
![设置内容](https://images.bsdayo.moe/ntfy-intro/pve-add-webhook.png)
